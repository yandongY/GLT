    ...
    <div>
        ...
        <div class="container main-container">
           ...
           <el-form ref="form" :model="form" style="padding: 0 267px 0 230px;margin-top:70px;">
              ...
              <div class="xieyi">注册即表示您同意<span>《 Grand Link Token 用户服务条款》</span></div>
              <el-form-item style="display: flex;justify-content:center;margin-top: 52px;" >
                  <el-button type="primary" @click="onSubmit" style="width:257px;height:47px;font-size:20px">注册</el-button>
              </el-form-item>
           </el-form>
        </div>
        <Footer/>
